...
- [X] Update browser-based coverage expectations for the visible grid behavior.

## Relevant Specs

- [X] `specs/02-board-layout-and-panels.spec.md`
- [X] `specs/07-browser-testing-and-qa.spec.md`
- [X] `specs/08-visual-design-tokens.spec.md`
...
- [X] Draw several strokes and add at least one text or shape element, then confirm the grid stays behind content and does not make the drawn content hard to read.
...
- [X] This story is complete only when the relevant items in `specs/02-board-layout-and-panels.spec.md`, `specs/07-browser-testing-and-qa.spec.md`, and `specs/08-visual-design-tokens.spec.md` have been checked `- [X]` where applicable and the manual Chrome DevTools browser test described above has been run successfully.
