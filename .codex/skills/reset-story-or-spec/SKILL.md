...
```bash
# Reset story 12
python .codex/skills/reset-story-or-spec/scripts/reset_story_or_spec.py story 12

# Reset spec 03
python .codex/skills/reset-story-or-spec/scripts/reset_story_or_spec.py spec 03

# Reset all specs
python .codex/skills/reset-story-or-spec/scripts/reset_story_or_spec.py all-specs
```
